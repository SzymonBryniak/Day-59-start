...
@app.route('/contact')
def get_contact():
  return render_template('contact.html', data= response, author="Api author", date=datetime.today().date())


@app.route('/post')
def get_post():
  return render_template('post.html', data= response, author="Api author", date=datetime.today().date())
